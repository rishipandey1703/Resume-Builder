...
const MinimalImageTemplate = ({ data, accentColor }) => {
    ...
    /*
     * Create object URL safely for newly uploaded images.
     * Server images are already strings and do not need an object URL.
     */
    useEffect(() => {
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-[30%_70%]">
                ...
                >
                    ...
                    {/* Name for mobile/sidebar visual identity */}
